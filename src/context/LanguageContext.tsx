...
export const translations = {
  en: {
    ...
    programme: {
      ...
      headline: "Programme",
      items: [
        { title: "Virunga Studies", dates: "January – March 2026" },
        { title: "Studio Open Days", dates: "Every Saturday" },
      ],
    },
    visit: {
      label: "Visit Us",
    ...
    cta: {
      ...
      circleBody: "34 collectors across 18 countries receive early access to new works, studio stories from Musanze, and Conservation program updates before anyone else.",
      circleWelcome: "Welcome to the circle.",
      emailPlaceholder: "Your email",
      joinBtn: "Join",
      perks: ["First access", "Commission priority", "Conservation reports"],
    },
    footer: {
      programme: "Programme",
      visit: "Visit",
    ...
    common: {
      ...
      donateLabel: "Add 5% to Conservation",
      donate: "Donate",
  ...
  fr: {
    ...
    programme: {
      ...
      headline: "Programme",
      items: [
        { title: "Études Virunga", dates: "Janvier – Mars 2026" },
        { title: "Portes ouvertes", dates: "Chaque samedi" },
      ],
    },
    visit: {
      label: "Visitez-nous",
    ...
    works: {
      ...
      shopByMedium: "Acheter par technique",
      newIn: "Nouveautés",
      shopAll: "Voir tout",
    },
    cta: {
      ...
      circleBody: "34 collectionneurs dans 18 pays reçoivent un accès anticipé aux nouvelles œuvres, aux histoires du studio à Musanze, et aux mises à jour du programme Conservation avant tout le monde.",
      circleWelcome: "Bienvenue dans le cercle.",
      emailPlaceholder: "Votre email",
      joinBtn: "Rejoindre",
      perks: ["Premier accès", "Priorité commande", "Rapports Conservation"],
    },
    footer: {
      programme: "Programme",
      visit: "Visiter",
    ...
    common: {
      ...
      donateLabel: "Ajouter 5% à Conservation",
      donate: "Faire un don",
  ...
  es: {
    ...
    programme: {
      ...
      headline: "Programa",
      items: [
        { title: "Estudios Virunga", dates: "Enero – Marzo 2026" },
        { title: "Días abiertos", dates: "Cada sábado" },
      ],
    },
    visit: {
      label: "Visítanos",
    ...
    works: {
      ...
      shopByMedium: "Comprar por técnica",
      newIn: "Novedades",
      shopAll: "Ver todo",
    },
    cta: {
      ...
      circleBody: "34 coleccionistas en 18 países reciben acceso anticipado a nuevas obras, historias del estudio en Musanze y actualizaciones del programa Conservation antes que nadie.",
      circleWelcome: "Bienvenido al círculo.",
      emailPlaceholder: "Tu email",
      joinBtn: "Unirse",
      perks: ["Acceso prioritario", "Prioridad encargos", "Informes Conservation"],
    },
    footer: {
      programme: "Programa",
      visit: "Visitar",
    ...
    common: {
      ...
      donateLabel: "Añadir 5% a Conservation",
      donate: "Donar",
